...
function KOTC:InitGameMode()
	print ( '[KOTC] Loading v' .. KOTCVERSION .. '!' )
	...
	GameRules:GetGameModeEntity().KOTC = self
	...
	GameRules:GetGameModeEntity():SetBountyRunePickupFilter( Dynamic_Wrap( KOTC, "BountyRunePickupFilter" ), self )
	GameRules:GetGameModeEntity():SetExecuteOrderFilter( Dynamic_Wrap( KOTC, "ExecuteOrderFilter" ), self )

	ListenToGameEvent( "game_rules_state_change", Dynamic_Wrap( KOTC, 'OnGameRulesStateChange' ), self )
	ListenToGameEvent( "npc_spawned", Dynamic_Wrap( KOTC, "OnNPCSpawned" ), self )
	ListenToGameEvent( "dota_team_kill_credit", Dynamic_Wrap( KOTC, 'OnTeamKillCredit' ), self )
	ListenToGameEvent( "entity_killed", Dynamic_Wrap( KOTC, 'OnEntityKilled' ), self )
	ListenToGameEvent( "dota_item_picked_up", Dynamic_Wrap( KOTC, "OnItemPickUp"), self )
	ListenToGameEvent( "dota_npc_goal_reached", Dynamic_Wrap( KOTC, "OnNpcGoalReached" ), self )
	...
	KOTC:CustomSpawnCamps()

	print ( '[KOTC] Loaded v' .. KOTCVERSION .. '!' )
end

function KOTC:CustomSpawnCamps()
...
---------------------------------------------------------------------------
function KOTC:ColorForTeam( teamID )
...
---------------------------------------------------------------------------
---------------------------------------------------------------------------
function KOTC:EndGame( victoryTeam )
...
---------------------------------------------------------------------------
function KOTC:UpdatePlayerColor( nPlayerID )
...
---------------------------------------------------------------------------
function KOTC:UpdateScoreboard()
	local sortedTeams = {}
...
---------------------------------------------------------------------------
function KOTC:GatherAndRegisterValidTeams()
...
function KOTC:spawncamp(campname)
	spawnunits(campname)
end
...
--------------------------------------------------------------------------------
function KOTC:ExecuteOrderFilter( filterTable )
	--[[
